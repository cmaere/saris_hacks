...
var_dump(isset($_POST['SUB_Results']))
...
elseif (isset($_POST['subvalidn']))
{
        echo '<meta http-equiv = "refresh" content ="0; 
				 url = lecturerGradebookAdd.php?r=1">';
                 exit;
}
//elseif(isset($_POST['SUB_Results']))
elseif($_POST['SUB_Results']))
{
...
elseif ((isset($_POST['MM_update'])) && ($_POST['MM_update'] == "form1"))
 {
...
elseif ((isset($_POST['view'])) && ($_POST['view'] == "Edit Records") || $_GET['clicked'] == 1)
{
        if($_GET['clicked'] == 1)
        {
