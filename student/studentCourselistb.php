...
if(isset($_POST['reg']))
{
    ...
    if($progcode == "ED" || $progcode == "COM" || $progcode == "MGT")
    {
...
?>
<form action="studentCourselistb.php" method="post" enctype="multipart/form-data" name="frmCourse" target="_self">
