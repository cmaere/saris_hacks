...
-->
	  ...
	  <table width="465" border="1" cellpadding="0" cellspacing="0" bgcolor="#CCCCCC">
        ...
        <tr>
			...
			<script language="JavaScript" src="datepicker/Calendar1-901.js" type="text/javascript"></script>
                <TD>
					<table border="0">
						<tr>
							<td><input type="text" class="vform" size="30" name="dtDate" value="<? echo $row_update['GradYear']?>"></td>
        ...
        <tr>
          ...
          <tr>
			  <td><div align="right">Program Registered:<span class="style2">*</span></div></td>
