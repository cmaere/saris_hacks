		   ...
		   echo '<meta http-equiv = "refresh" content ="0; 
	 	   ...
	 	   echo '<meta http-equiv = "refresh" content ="0; 
				 url = accommodation/housingindex.php">';
					exit;
		 } elseif (($module=='3' && $RegNo2 == 'KCN/BSCN/' && $RegNo3 != 'UCM' )||($module=='3' && $RegNo2 == 'KCN/DIPN/' && $RegNo3 != 'UCM' )) {
			 //die("here".$year);
			...
			If($trimip == "10.60.61" || $trimipa == "192.168" || $ip == "41.70.64.2" || $ip == "41.70.64.3")
			{
	 	    ...
	 	    echo '<meta http-equiv = "refresh" content ="0; 
						url = http://10.60.61.7:8003/feecheckyear1.php?accpacid='.$accpacid.'&year='.$year.'&module='.$module.'&semester='.$semester.'&user='.$username.'&mtumiaji='.$mtumiaji.'&regno='.$RegNo.'&privilege='.$privilege.'&loginName='.$loginName.'&userFaculty='.$userFaculty.'&weaver='.$weaver.'">';
			...
			else
			{
				//die("here");
				 ...
				 echo '<meta http-equiv = "refresh" content ="0; 
						url = http://41.70.64.2:8003/feecheckyear1.php?accpacid='.$accpacid.'&year='.$year.'&module='.$module.'&semester='.$semester.'&user='.$username.'&mtumiaji='.$mtumiaji.'&regno='.$RegNo.'&privilege='.$privilege.'&loginName='.$loginName.'&userFaculty='.$userFaculty.'&weaver='.$weaver.'">';
