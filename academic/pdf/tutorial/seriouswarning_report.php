...
function arrenger($date,$status1,$status2)
{
	$this->SetFont('Times','',10);
    ...
    $this->Cell(22,5,"$status1");
    $this->Ln(4);
    $this->Cell(50,5,"$status2"); 
    $this->Ln(9);
    $this->SetFont('Times','',10);
    $this->Cell(0,5,"Your overall performance is as follows: "); 
	$this->Ln(6);
}
function salutation($status)
{
    ...
    $this->Ln(4);
	$this->Cell(59,5,"year or withdraw from college. As this is ");
    $this->SetFont('Times','B',10);
    $this->Cell(30,5,"a Serious Warning,");
    $this->SetFont('Times','',10);
    $this->Cell(36,5,"if your performance does not improve, you may");
    $this->Ln(4);
	$this->Cell(59,5,"be required to withdraw without any further warning.");
	$this->Ln(8);
    $this->SetFont('Times','',10);
...
$date=date(' d \of F Y');
$status1='Undoubted Failure Mark in one or more courses and/or more than. one';
$status2='Marginal Failure Mark';
$classID='BIT4';
$semester_ID=1;
...
$pdf->arrenger($date,$status1,$status2);
