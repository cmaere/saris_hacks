...
function arrenger($date,$status,$course)
{
    ...
    $this->Ln(4);
    $this->Cell(13,5,"that you "); 
    $this->SetFont('Times','B',10);
    $this->Cell(35,5,"$status "); 
    $this->SetFont('Times','',10);
    $this->Cell(53,5,"from College on academic grounds. You have been seioursly warned in the year, and");
    $this->Ln(4);
    $this->Cell(13,5,"in your examination you either failed at least 40% of the courses you were studying or failed three courses with an"); 
    $this->Ln(4);
    $this->Cell(13,5,"overall everage grade of less than 45."); 
    $this->Ln(9);
...
/*function salutation($date1,$date2,$preparation_date,$status)
{
	...
	$this->SetFont('Times','',10);
    $this->Ln(4);
	$this->Cell(0,5,"Supplementary examinations have been scheduled from $date1 to $date2.You will be expected");
    $this->Ln(4);
    $this->Cell(13,5,"to be in college on $preparation_date for preparation if you reside on campus."); 
    $this->SetFont('Times','',10);
    $this->Ln(9);
    ...
    $this->SetFont('Times','',10);
    $this->Cell(0,5,"the year, if you have not ");
    $this->Ln(4);
    $this->Cell(73,5,"already done so; otherwise you will be expected to");
    $this->SetFont('Times','B',10);
    $this->Cell(19,5,"$proceed");
    $this->SetFont('Times','',10);
    $this->Cell(18,5,"with your studies. In either case, you will be ");
    $this->Ln(4);
    $this->Cell(110,5,"registered only after paying the tuition fees.");    
