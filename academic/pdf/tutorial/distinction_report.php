...
function arrenger($date,$status,$course)
{
    ...
    $this->Ln(4);
    $this->Cell(75,5,"that you PASS your examinations and be awarded a"); 
    $this->SetFont('Times','B',10);
    $this->Cell(48,5,"$course");
    $this->SetFont('Times','',10);
    $this->Cell(7,5,"with");
    $this->SetFont('Times','B',10);
...
function salutation($date1,$date2,$preparation_date,$status)
{
	...
	$this->SetFont('Times','',10);
    $this->Ln(4);
	$this->Cell(118,5,"You will be advised of the graduation date in due course.");
    $this->Ln(8);
	$this->Cell(36,5,"Please accept my sincere");
    $this->SetFont('Times','B',10);
