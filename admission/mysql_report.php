...
function connect($host='localhost',$username='root',$password='',$db='zalongwaifm'){
	$this->conn = mysql_connect('localhost','root','') or die( mysql_error() );
	mysql_select_db('zalongwaifm',$this->conn) or die( mysql_error() );
	return true;
}
