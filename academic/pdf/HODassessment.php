...
function data()
{
 ...
 var semister = document.frmDept.semister.value
    ...
    self.location='pdf/tutorial/hod_pdf.php?program=' + program +'&deptid=' + deptid +'&year=' + year +'&semister=' + semister +'&index=1';
...
<fieldset>
	<legend>Select Programme Year</legend>
		<form action="HODassessment.php" method="post" enctype="multipart/form-data" name="frmDept" target="_self">
		<table width="200" border="1" cellpadding="0" cellspacing="0">
		  ...
		  <tr>
            ...
            where  e.CourseCode = s.courseCode and s.dept = $deptid and e.Ayear = $year and e.assessment_status = $cat
            ...
            else if($semister == "Semester I")
            {
                //$cat = 4;
            $sql1 =  "select distinct e.programme  from examdate e, submitresult s 
            where  e.CourseCode = s.courseCode and s.dept = $deptid and e.Ayear = $year 
            order by e.programme asc
            ";
            }
            else
...
<fieldset>
	<legend>Select Appropriate Entries</legend>
		<form action="HODassessment.php" method="post" enctype="multipart/form-data" name="frmCourse" target="_self">
		<table width="200" border="1" cellpadding="0" cellspacing="0">
