...
function arrenger($date,$status,$course)
{
    ...
    $this->SetFont('Times','B',10);
    $this->Cell(15,5,"$status "); 
    $this->SetFont('Times','',10);
    $this->Cell(53,5,"the year."); 
    $this->Ln(9);
...
function salutation($date1,$date2,$preparation_date,$status)
{
    ...
    $time='9:00 am';    
    $this->Ln(4);
	$this->Cell(0,5,"You are earnestly being urged to see your Dean or Head of Department concerned as soon as possible, to discuss your ");
	$this->Ln(4);
	$this->Cell(0,5,"work and consider ways in which you can improve your academic performance.  If I can be of further assistance,");
    $this->Ln(4);
	$this->Cell(0,5,"please do not hesitate to see me.");
    $this->SetFont('Times','',10);
    $this->Ln(8);
	$this->Cell(0,5,"The academic year will begin on $date2. Registration will take place on $date2 and ");
    $this->Ln(4);
    $this->Cell(13,5,"$preparation_date from $time. Please note that you will ONLY be registered after having paid tuition fees. The"); 
    $this->SetFont('Times','',10);
    $this->Ln(4);
    $this->Cell(17,5,"College will communicate any changes that may occur with regards to the opening date.");
