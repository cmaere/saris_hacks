...
function data()
{
 ...
 var semister = document.frmDept.semister.value
    ...
    self.location='roomapp_rtp2.php?program=' + program +'&year=' + year +'&semister=' + semister +'&index=1';
...
#get connected to the database and verfy current session
	...
	$szSubSection = 'Room Application';
	$szTitle = 'Room Application';
	...
	<legend>Select Programme Year</legend>
		...
		<table width="200" border="1" cellpadding="0" cellspacing="0">
		  ...
		  <tr>
            ...
            where  e.CourseCode = s.courseCode and e.Ayear = $year and e.Semister = '$semister'
	...
	<legend>Select Programme Year</legend>
		...
		<table width="200" border="1" cellpadding="0" cellspacing="0">
		  ...
		  <tr>
            ...
            <option value="">---select---</option>
            <?php
            $sql1 =  "select distinct degree  from roomapp
