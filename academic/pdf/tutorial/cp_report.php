...
function arrenger($date,$status,$course)
{
    ...
    $this->Ln(4);
    $this->Cell(17,5,"that you be"); 
    $this->SetFont('Times','B',10);
    $this->Cell(28,5,"$status "); 
    $this->SetFont('Times','',10);
    $this->Cell(60,5,"in the course you failed and be awarded a"); 
    $this->SetFont('Times','B',10);
    $this->Cell(22,5,"$course");
    $this->Ln(9);
...
function salutation($date1,$date2,$preparation_date,$status)
{
	...
	$this->SetFont('Times','',10);
    $this->Ln(4);
	$this->Cell(118,5,"You will be advised of the graduation date in due course. Please accept my sincere");
    $this->SetFont('Times','B',10);
    $this->Cell(22,5,"CONGRATULATIONS.");
...
$pdf->arrenger($date,$status,$programme);
